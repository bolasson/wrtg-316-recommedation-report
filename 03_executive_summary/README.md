...
Abbreviated form of my report, all the sexy stuff from my full report.
Same structure of the main paper.
Only the essential part.
Use sources and include evidence.
Clear intro and conclusion.

DON'T REPEAT WHAT I SAY IN THE INTRO! (THAT'S SELF PLAGERISIM)

HAVE THE TONE, SOURCES, ORDER, and AUDIENCE!

When you introduce something, review them in the same order.


Abbreviated Paper:

5.1 The techinical debt builds up with any development team. However, our team is more prone to this debt due to having a high employee turnover rate, student software developers, and unregulated generative artificial intelligence use.
5.2 The combindation of the above leads to quick fixes that become difficult to maintain or cause bugs in the long run.
5.3
